...
import { StampService, path } from './stamp.service';
...
describe('StampService', () => {
    ...
    it('click should draw the stamp', ()=>{
      ...
      addEventListener('action', ()=>{ actionCalled = true;});
    ...
    it('onWheel should change the orientation', () => {
      ...
      expect(service.pointWidth).toEqual(15);
      expect(drawStampSpy).toHaveBeenCalled();
      ...
      service.onWheel(wheelEvent);
      expect(service.pointWidth).toEqual(14);
      expect(drawStampSpy).toHaveBeenCalled();
    });
    ...
    it('doAction', () => {
        ...
        let setting = (service as any).saveSetting();
